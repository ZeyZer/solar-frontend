...
function QuoteLoading({ progress }) {
  const steps = [
    { key: "starting", label: "Starting" },
    { key: "fetching_pvgis", label: "PVGIS modelling" },
    { key: "modelling_demand", label: "Demand profile" },
    { key: "simulating_battery", label: "Solar + battery simulation" },
    { key: "financials", label: "Financials" },
    { key: "optimising_battery", label: "Battery recommendations" },
    { key: "finalising", label: "Finalising quote" },
  ];

  const currentIndex = Math.max(0, steps.findIndex((s) => s.key === progress.step));
      ...
      <div className="container-app py-12">
        <div className="card mx-auto max-w-2xl">
          <div className="cardHeader">
            <div className="cardTitle">Calculating your quote…</div>
          </div>
          ...
          <div className="cardBody">
            ...
            {/* Progress bar */}
            <div className="mt-6">
              <div className="h-3 w-full overflow-hidden rounded-pill bg-soft">
                <div
                  className="h-full rounded-pill bg-ink transition-all duration-700 ease-out"
                  ...
                  <div key={s.key} className="flex items-center gap-3">
                    <div
                      className={[
                        ...
                        done ? "bg-ink" : active ? "bg-ink animate-pulse" : "bg-line",
                      ].join(" ")}
                    />
                    <div
                      className={[
            ...
            <p className="mt-6 text-micro text-muted">
              Note: PVGIS modelling uses a 3-year average when available.
            </p>
          </div>
        </div>
      </div>
